...
assertthat::assert_that(file.exists("./loan_test.csv"))
assertthat::is.readable("./loan_test.csv")
raw_data <- read.csv("./loan_test.csv")

assertthat::assert_that(file.exists("./loan_train.csv"))
assertthat::is.readable("./loan_train.csv")
raw_data <- read.csv("./loan_train.csv")
